...
%CL% -EB -bataritos -x -Bstatic -Cvbcc -nostdlib "%link_sdk%\VBCC\targets\m68k-atari\lib\startup16.o"  source/*.o  %GFX_LIB% -s -L"%link_sdk%\VBCC\targets\m68k-atari\lib" -lvc16 -o %OUT%\%NAME%
